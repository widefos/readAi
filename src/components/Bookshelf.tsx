            ...
            >
              ...
              <div className="px-1">
                ...
                {progress[book.id] !== undefined && (
                  <p className="text-[7px] font-bold opacity-20 uppercase tracking-widest mt-1">已读至第 {progress[book.id] + 1} 页</p>
                )}
              </div>
            </motion.div>
          ))}

          {/* Empty State / Add Book Placeholder */}
          <button 
            onClick={onUploadClick}
            className="aspect-[2/3] rounded-sm border-2 border-dashed border-gray-100 flex flex-col items-center justify-center p-8 hover:border-indigo-200 hover:bg-indigo-50/20 transition-all group"
          >
